...
//				$update_query = "UPDATE board SET hits=hits+1 WHERE bno='".$bno."'";
			...
			echo "<tr><th>Date</th><td>" . $board['written_date'] . "</td></tr>";
			...
			mysqli_close($conn);
		?>	
		<br><a href="./board_write.php"><button>글작성</button></a>
		<br><a href="./board_modify.php"><button>글수정</button></a>
		<br><a href="./board_delete.php"><button>글삭제</button></a>
